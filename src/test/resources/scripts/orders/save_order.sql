...
INSERT INTO users (user_id, username, password, email, full_name, activated, deleted)
VALUES ('58fae25b-ea38-4e7b-ab2d-9f555a67836b', 'user test', 'password', 'email@gmail.com', 'Client Name', true, false);